            ...
            <div class="col-lg-9">
                <div class="row">
                    <div class="col-sm col-md-6 col-lg-4 ftco-animate">
                        <div class="room">
                            <a href="{{route('room-single')}}" class="img d-flex justify-content-center align-items-center"
                            ...
                            <div class="text p-3 text-center">
                                ...
                                <hr>
                                <p class="pt-1"><a href="{{route('room-single')}}" class="btn-custom">Book Now <span
                    ...
                    <div class="col-sm col-md-6 col-lg-4 ">
                        <div class="room">
                            ...
                            <div class="text p-3 text-center">
                                ...
                                <hr>
                                <p class="pt-1"><a href="room-single.html" class="btn-custom">Book Now <span
                                            class="icon-long-arrow-right"></span></a></p>
                            </div>
                        </div>
                    </div>

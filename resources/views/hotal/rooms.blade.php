...
<div class="hero-wrap" style="background-image: url('{{ asset('assets/hotal/grand2.jpg') }}'); min-height: 500px; border-radius: 10px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">

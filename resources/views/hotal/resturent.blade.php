			...
			<div class="row">
				...
				<div class="col-md-7 py-5 wrap-about pb-md-5 ftco-animate">
					...
					<div class="pb-md-4">
						...
						<p class="pl-md-5">When she reached the first hills of the Italic Mountains, she had a last view
							back on the skyline of her hometown Bookmarksgrove, the headline of Alphabet Village and the
							subline of her own road, the Line Lane. Pityful a rethoric question ran over her cheek, then
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="pricing-entry d-flex ftco-animate">
						<div class="img" style="background-image: url('{{ asset('assets/images/menu-7.jpg') }}')"></div>
						<div class="desc pl-3">
							<div class="d-flex text align-items-center">
								<h3><span>Grilled Beef with potatoes</span></h3>
								<span class="price">$20.00</span>
					...
					<div class="pricing-entry d-flex ftco-animate">
						<div class="img" style="background-image: url('{{ asset('assets/images/menu-8.jpg') }}')"></div>
						<div class="desc pl-3">
							<div class="d-flex text align-items-center">
